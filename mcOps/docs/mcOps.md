...
Monte Carlo programmes for generating TPS matched beam models and running
simulations

*BADGES* - can add badges of metadata such as version info  
([shields.io](https://shields.io/) gives many good options).

## Installation

Installed as part of `agPython` with installation outlined in that README.md

### Requirements

`subProcess` package to allow parallelised computation
`dataOps > dataClass > pbtDICOM` data classes used when creating sources
